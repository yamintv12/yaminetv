 function handleLogoError(imgElement) {
        ...
        const newsArticlesData = [
            {
                ...
                author: "Sports Desk",
                time: "2 hours ago",
                img: "https://res.cloudinary.com/dv8uywtbo/image/upload/v1752710550/t20-wc_ln5ou8.jpg",
            ...
            },
            {
                ...
                time: "4 hours ago",
                img: "https://res.cloudinary.com/dv8uywtbo/image/upload/v1752710550/odi-wc_y5t0m8.jpg",
            ...
            },
            {
                ...
                time: "6 hours ago",
                img: "https://res.cloudinary.com/dv8uywtbo/image/upload/v1752710550/nepal-fan_cpbzvh.jpg",
            ...
            },
            {
                ...
                time: "8 hours ago",
                img: "https://res.cloudinary.com/dv8uywtbo/image/upload/v1752710549/fifa-2022-arg_mbv6hg.jpg",
            ...
            },
            {
                ...
                author: "",
                time: "12 hours ago",
                img: "https://res.cloudinary.com/dv8uywtbo/image/upload/v1752710549/cr7-real_cnqfyw.jpg",
            ...
            },
            {
                ...
                time: "1 day ago",
                img: "https://res.cloudinary.com/dv8uywtbo/image/upload/v1752710549/james-cl_dti5ux.jpg",
        ...
        function toggleMobileMenu() {
            ...
            if (navMenu.classList.contains('active')) {
                ...
                mobileToggle.focus(); // Return focus to the toggle button
            }
        }
        ...
        function renderNewsArticles(startIndex, count) {
            ...
            for (let i = startIndex; i < endIndex; i++) {
                ...
                newsImg.src = articleData.img;
                newsImg.alt = articleData.title; // Use title for alt text
                newsImg.loading = 'lazy'; // Lazy loading for news images
        ...
        function renderTrendingNewsCards() {
            ...
            newsArticlesData.forEach(articleData => {
                ...
                newsImg.src = articleData.img;
                newsImg.alt = articleData.title; // Use title for alt text
                newsImg.loading = 'lazy'; // Lazy loading for carousel images
                newsImg.onerror = function() { handleNewsImageError(this); };
                newsImageContainer.appendChild(newsImg);
                newsCard.appendChild(newsImageContainer);
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            try {
                // Initialize newsLoadedCount before rendering the first batch of news
                newsLoadedCount = 0;
                renderNewsArticles(newsLoadedCount, LOAD_LIMIT);
                newsLoadedCount += LOAD_LIMIT;
            } catch (e) {
            ...
            try {
                ...
                if (newsCarouselWrapper) {
                    ...
                    // Add keyboard navigation for carousel if needed for full accessibility
                }
            } catch (e) {
        ...
        const newsObserverTargetNode = document.getElementById('news'); 
        ...
        document.addEventListener('DOMContentLoaded', () => {
            // Re-observing already present news cards on initial load
            const cards = document.querySelectorAll('.news-section .news-card'); 
            cards.forEach(card => {
                animationObserver.observe(card);
            });
        });
